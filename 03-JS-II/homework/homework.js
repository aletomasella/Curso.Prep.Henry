...
function obtenerMayor(x, y) {
  ...
  // Tu código:
  // se puede hacer con return Math.max (x,y)
  if (x > y) {return x;}
   if (y > x) {return y;} 
   if (x === y) {return x || y}
...
function fizzBuzz(numero) {
  ...
  // Se puede sacar el multiplo multiplicando 3 * 5 === 15 y usar eso en vez del &&
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  // La letra i viene de index o indice (por eso se suele usar la letra i)
